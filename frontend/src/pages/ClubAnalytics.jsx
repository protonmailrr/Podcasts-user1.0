...
import { TrendingUp, Users, Mic, Award, Headphones, Play, Heart, Settings, Crown } from 'lucide-react';
              ...
              <CardContent className="space-y-4">
                {clubSettings ? (
                  <>
                    ...
                    {clubSettings.badge_definitions && clubSettings.badge_definitions.length > 0 && (
                      <div className="mt-6 pt-6 border-t">
                        <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          {clubSettings.badge_definitions.map((badge) => (
                            <div key={badge.id} className="p-4 bg-white border rounded-lg hover:shadow-md transition-shadow">
