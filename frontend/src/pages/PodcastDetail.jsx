                    ...
                    {podcast.ai_summary ? (
                      <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-4">
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <span className="font-semibold text-emerald-700">AI Generated Summary</span>
                        </div>
                        <p className="text-gray-700 leading-relaxed">{podcast.ai_summary}</p>
                      </div>
                    ) : (
                      <div className="text-center py-8">
                        <Sparkles className="w-10 h-10 text-gray-300 mx-auto mb-3" />
                        <p className="text-gray-500 mb-4">AI summary will be generated after audio upload.</p>
                        <p className="text-xs text-gray-400">
                          Upload audio → Transcription → AI Analysis → Summary
                        </p>
                      </div>
                    )}
                  </TabsContent>
