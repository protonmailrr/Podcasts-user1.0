      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            {/* Tabs - Description, Transcript, AI Summary - Moved to right column */}
            <Card className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                <div className="border-b border-gray-100">
                  <TabsList className="w-full bg-transparent p-0 h-auto">
                    <TabsTrigger 
                      value="description" 
                      className="flex-1 py-3 text-xs sm:text-sm rounded-none border-b-2 border-transparent data-[state=active]:border-emerald-500 data-[state=active]:bg-transparent"
                    >
                      <span className="flex items-center">
                        Description
                        <TabInfoTooltip
                          title="Description"
                          description="Podcast description added by the author. Contains brief information about the topic and content of the episode."
                          status={{ active: !!podcast?.description, text: podcast?.description ? 'Description available' : 'No description' }}
                        />
                      </span>
                    </TabsTrigger>
                    <TabsTrigger 
                    ...
                    >
                      <span className="flex items-center">
                        ...
                        <TabInfoTooltip
                          title="Transcript"
                          description="Full text transcription of the podcast audio. Generated automatically using AI after audio upload."
                          formula="Audio → Speech-to-Text AI → Transcript"
                          status={{ active: !!podcast?.transcript, text: podcast?.transcript ? 'Transcript ready' : 'Pending generation' }}
                        />
                      </span>
                    </TabsTrigger>
                    <TabsTrigger 
                    ...
                    >
                      <span className="flex items-center">
                        ...
                        <TabInfoTooltip
                          title="AI Summary"
                          description="Brief summary of the podcast generated by artificial intelligence based on the transcript. Highlights key topics and ideas."
                          formula="Transcript → LLM Analysis → Summary"
                          status={{ active: !!podcast?.ai_summary, text: podcast?.ai_summary ? 'AI Summary ready' : 'Pending analysis' }}
                        />
                      </span>
                    </TabsTrigger>
                  </TabsList>
                ...
                <div className="p-4 max-h-[400px] overflow-y-auto">
                  <TabsContent value="description" className="mt-0">
                    {podcast.description ? (
                      <p className="text-gray-700 text-sm leading-relaxed whitespace-pre-wrap">{podcast.description}</p>
                    ) : (
                  ...
                  <TabsContent value="transcript" className="mt-0">
                    {podcast.transcript ? (
                      <p className="text-gray-700 text-sm leading-relaxed whitespace-pre-wrap">{podcast.transcript}</p>
                    ) : (
                      <div className="text-center py-6">
                        <Loader2 className="w-8 h-8 text-gray-300 mx-auto mb-2 animate-spin" />
                        <p className="text-gray-400 text-sm">Transcript will be generated after audio upload.</p>
                      </div>
                    )}
                  </TabsContent>
                  ...
                  <TabsContent value="ai" className="mt-0">
                    {podcast.ai_summary ? (
                      <div>
                        ...
                        <p className="text-gray-700 text-sm leading-relaxed">{podcast.ai_summary}</p>
                      </div>
                    ) : (
                      <div className="text-center py-6">
                        <Sparkles className="w-8 h-8 text-gray-300 mx-auto mb-2" />
                        <p className="text-gray-400 text-sm">AI summary will be generated after audio upload.</p>
                      </div>
                    )}
                  </TabsContent>
                </div>
